...
class login_pageState extends State<login_page>{
  ...
  final TextEditingController _UserReg = new TextEditingController();
  ...
  Future signInTheUser()async{
    ...
    FirebaseAuth.instance.signInWithEmailAndPassword(
        email: '${_UserReg.text.toString().trimLeft().trimRight()}@manipal.com',
        ...
        Navigator.of(context)
            ...
            (BuildContext context)=>new myActivitiesPage(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  (_loading==0)?GestureDetector(
                    ...
                    onTap: () async{
                      if(_UserReg.text.toString().trimLeft().trimRight().length!=0 &&
                          _UserPassword.text.toString().trimLeft().trimRight().length!=0
                      ){
                        setState(() {
                          _loading = 1;
                        });
                    ...
                    onTap: (){
                      Navigator.of(context).push(
                        new MaterialPageRoute(
                            builder: (BuildContext context)=>new sign_up_page()
                        )
                      );
                    },
                  ):Container()
