...
class chiefWardenMainActivity extends StatefulWidget{

  final String WardenID;

  const chiefWardenMainActivity({Key key, this.WardenID}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new chiefWardenMainActivityState();
  }

}

class chiefWardenMainActivityState extends State<chiefWardenMainActivity>{
...
//  }
  ...
  Widget _mainWardenPage(){
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('ChiefWarden').
        ...
        builder: (BuildContext context){
          return Container(
              ...
              child: Scaffold(
                ...
                body: _onlyForSearch(registrationNoOfStudent.text),
              )
          );
        }
    );
    ...
    return new Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(
            padding: EdgeInsets.only(top:85.0,left: 10.0,right: 10.0),
            decoration: BoxDecoration(
                ...
                actions: <Widget>[
                  ...
                  GestureDetector(
                    child: Container(
                      ...
                      width: 50.0,
                      margin: EdgeInsets.all(10.0),
                      child: Icon(Icons.power_settings_new,color: Colors.yellowAccent,size: 50.0,),
                    ),
                    onTap: (){
                      FirebaseAuth.instance.signOut().whenComplete((){
                        Navigator.of(context)
                            .pushReplacement(
                            new MaterialPageRoute(builder: (BuildContext context)=>new welcome_screen())
                        );
                      }).catchError((error){
