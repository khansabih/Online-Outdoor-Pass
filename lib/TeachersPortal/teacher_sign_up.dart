...
class teachers_sign_up extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new teachers_sign_up_State();
  }

}

class teachers_sign_up_State extends State<teachers_sign_up>{
  ...
  final TextEditingController teacherRegNo = new TextEditingController();
  ...
  Future uploadProfilePic(String user_id) async{
    StorageReference picRef = FirebaseStorage.instance.ref().child('teacher_profile_images/${user_id}.png');
  ...
  void uploadDetails() async {
    _mAuth.createUserWithEmailAndPassword(
        email: '${teacherRegNo.text.toString().trimLeft().trimRight()}@teacheratMUJ.com',
      ...
      if(_profileImage==null){
        ...
        Firestore.instance.collection('Teachers')
          ...
          'registrationNo':'${teacherRegNo.text.toString().trim()}',
