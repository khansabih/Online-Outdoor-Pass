...
class teacher_profile extends StatefulWidget{
  ...
  final String user_Name,user_branch,user_course,user_mobile,user_registration_no,user_profile_pic;

  const teacher_profile({Key key, this.user_Name, this.user_branch, this.user_course, this.user_mobile, this.user_registration_no, this.user_profile_pic}) : super(key: key);


  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return new teacher_profileState();
  }

}

class teacher_profileState extends State<teacher_profile>{
